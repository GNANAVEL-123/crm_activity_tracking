...
frappe.query_reports["Missed Tracking Events"] = {
	"filters": [
		{
			fieldname: 'date',
			label: 'Date',
	...
	onload: function(report){
		...
		frappe.call({
			...
			method: "crm_activity_tracking.crm_activity_tracking.report.missed_tracking_events.missed_tracking_events.get_user_list",
...
frappe.call({
    ...
    callback: function(r) {
        ...
        if (showQuotationFilter) {
            frappe.query_reports["Missed Tracking Events"].filters.push({
                fieldname: 'quotation',
                label: 'Quotation',
                fieldtype: 'Check',
