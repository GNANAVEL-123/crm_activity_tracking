...
def make_quotation(source_name, target_doc=None):
	...
	item_li = []
	if hasattr(lead_doc, 'custom_item_request_type') and lead_doc.custom_item_request_type:
		for i in lead_doc.custom_item_request_type:
			if hasattr(i, 'item') and i.item:
				item_li.append(i.item)
	if item_li:
		for item_code in item_li:
			target_doc.append("items", {"item_code": item_code})
	# thirvusoft edit end
